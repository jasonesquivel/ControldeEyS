Public Class Rptcorrecciones
    ...
    Sub llenarGrid()
        ...
        dgv.Columns(3).HeaderText = "Entrada asignada"
        dgv.Columns(4).HeaderText = "Salida asignada"
        dgv.Columns(5).HeaderText = "Entrada marcada"
        dgv.Columns(6).HeaderText = "Salida marcada"
