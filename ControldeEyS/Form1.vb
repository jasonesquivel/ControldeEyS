...
Public Class Form1
    ...
    Sub llenarGrid()
        Try
            ...
            DataGridView1.Columns(3).HeaderText = "Entrada Asignada"
            DataGridView1.Columns(4).HeaderText = "Salida Asignada"
            DataGridView1.Columns(5).HeaderText = "Marca de entrada"
            DataGridView1.Columns(6).HeaderText = "Marca de salida"
